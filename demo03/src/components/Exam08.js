...
const Exam08 = ()=>{
    const [names,setNames] = useState(['피카츄','라이츄','파이리','꼬부기']);
    ...
    //- key 속성은 반드시 유일해야 한다(주의)/백엔드에서 데이터를 가져오면 PK를 사용한다
    //- 도저히 사용할 값이 없다면 map에 두 번째 매개변수인 index를 사용
    return(
        <>
        <h1>배열 형태의 상태변수</h1>
        {/* 밑으로 enter쳐서 쓸 땐 괄호로 묶어줘야 함 */}
