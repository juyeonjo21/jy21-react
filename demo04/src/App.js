...
function App() {
  ...
  const editTodoList = (todo) => {
    // setEditData(todo);//안되는 코드(=얕은 복사 : shallow dopy)
      ...
      <div className="row">
        <div className="col-md-8 offset-md-2">
          ...
          <div className="row mt-4">
            ...
            <div className="col-3">
              <button className="btn btn-secondary w-100" onClick={addTodoList}>
                <AiOutlinePlus />
                추가
              </button>
            </div>
        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            ...
            <div className="modal-footer">
                <button className="btn btn-dark" onClick={clearEditData}>취소</button>
                <button className="btn btn-success ms-2" onClick={saveTodoList}>저장</button>
              </div>
